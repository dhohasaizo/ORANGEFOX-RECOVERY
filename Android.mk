...
ifneq ($(OF_DISABLE_MIUI_SPECIFIC_FEATURES),)
    LOCAL_CFLAGS += -DOF_DISABLE_MIUI_SPECIFIC_FEATURES='"$(OF_DISABLE_MIUI_SPECIFIC_FEATURES)"'
else
    LOCAL_CFLAGS += -DOF_DISABLE_MIUI_SPECIFIC_FEATURES='""'
endif
